...
struct user_struct {
	...
	struct user_struct *l_next, *l_prev; // Extra pointers to set two way hashtable
	struct task_struct *move_task;       // Keep current process pointer
	long cpu_ticks;						 // How much CPU resource can this user actually use
	uid_t uid;
};
